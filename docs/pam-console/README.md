...
0g. **`teleprompter-spec.md`** *(21 September 2026)*: the build spec for the teleprompter, written from the one that runs here, for the agent rebuilding it on marrsattacks.world (D118).
